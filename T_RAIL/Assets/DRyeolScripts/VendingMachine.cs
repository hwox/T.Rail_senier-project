                    ...
                    if (targetbutton == button[i])
                    {
                        ...
                        if (TrainGameManager.instance.CoinNum >= item_price[i])
                        {
                            ...
                            else
                            {
                                ...
                                itemCtrl.GetComponent<AllItem_Ctrl>().VendingMachine_ItemGet(myPlayer.GetComponent<PhotonView>().ViewID,i + 1);
                            }
                        ...
                        {
                            //Debug.Log("돈 부족");
                            itemCtrl.GetComponent<AllItem_Ctrl>().VendingMachine_ItemGet(myPlayer.GetComponent<PhotonView>().ViewID, 627);
                        }
                    }
                }
            }
