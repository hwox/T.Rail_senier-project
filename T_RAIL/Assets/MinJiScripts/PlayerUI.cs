...
namespace Photon.Pun.Demo.PunBasics
{
   ...
   //         }
		...
		public void SetTarget(playerManager_minj _target){
            ...
            if (_characterController != null){
                characterControllerHeight =  _characterController.height + 30;
            }

            if (playerNameText != null) {
                playerNameText.text = this.target.gameObject.GetPhotonView().Owner.NickName;
			}
		}
